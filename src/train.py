...
def run(arguments, tag_in_vcs=False) -> None:
    ...
    # model_class = model_restore_helper.get_model_class_from_name('1dcnn')
    # model_class = model_restore_helper.get_model_class_from_name('rnn')
    model_class = model_restore_helper.get_model_class_from_name('selfatt')
